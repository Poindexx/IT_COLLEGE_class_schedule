...
public class tabItem5  extends Fragment {
    ...
    public void onResume() {
        ...
        if (arrayList != null) {
            ...
            try {
                cursor = databaseHelper.QueryData("select * from dbnew" + " where (mugalim='" + id_grop + "' and day=5) or (grop='" + classID + "' and day=5) or (kobinet='" + classID + "' and day=5)" + "ORDER BY par ASC");
                if (cursor != null) {
