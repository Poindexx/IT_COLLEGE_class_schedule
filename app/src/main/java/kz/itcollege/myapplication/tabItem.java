...
public class tabItem  extends Fragment {
    ...
    public void onResume() {
        ...
        if (arrayList != null) {
            ...
            try {
                cursor = databaseHelper.QueryData("select * from dbnew" + " where (mugalim='" + id_grop + "' and day=1) or (grop='" + classID + "' and day=1) or (kobinet='" + classID + "' and day=1)" + "ORDER BY par ASC");
                if (cursor != null) {
