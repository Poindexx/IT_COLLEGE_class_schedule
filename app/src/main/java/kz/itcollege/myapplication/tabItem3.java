...
public class tabItem3  extends Fragment {
    ...
    public void onResume() {
        ...
        if (arrayList != null) {
            ...
            try {
                cursor = databaseHelper.QueryData("select * from dbnew" + " where (mugalim='" + id_grop + "' and day=3) or (grop='" + classID + "' and day=3) or (kobinet='" + classID + "' and day=3)" + "ORDER BY par ASC");
                if (cursor != null) {
