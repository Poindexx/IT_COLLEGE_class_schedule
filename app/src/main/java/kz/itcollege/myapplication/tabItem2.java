...
public class tabItem2  extends Fragment {
    ...
    public void onResume() {
        ...
        try {
            cursor = databaseHelper.QueryData("select * from dbnew" + " where (mugalim='" + id_grop + "' and day=2) or (grop='" + classID + "' and day=2) or (kobinet='" + classID + "' and day=2)" + "ORDER BY par ASC");
            if (cursor != null) {
