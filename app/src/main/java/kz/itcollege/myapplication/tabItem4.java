...
public class tabItem4  extends Fragment {
    ...
    public void onResume() {
        ...
        if (arrayList != null) {
            ...
            try {
                cursor = databaseHelper.QueryData("select * from dbnew" + " where (mugalim='" + id_grop + "' and day=4) or (grop='" + classID + "' and day=4) or (kobinet='" + classID + "' and day=4)" + "ORDER BY par ASC");
                if (cursor != null) {
